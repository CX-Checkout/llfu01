...
def checkout(skus):
	...
	total_price =  five_v_price + three_v_price + v_price * double_left_v_count

	total_price = total_price + t_price * skus.count("X")
	total_price = total_price + t_price * skus.count("Y")
	total_price = total_price + t_price * skus.count("Z")
